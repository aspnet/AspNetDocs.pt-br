...
O [aplicativo finalizado](https://github.com/dotnet/AspNetDocs/tree/master/aspnet/mvc/overview/deployment/docker-aspnetmvc/samples/MVCRandomAnswerGenerator) está no GitHub.
...
1. Clique no **botão perfil personalizado**e, em seguida, selecione **sistema de arquivos** como o método.
...
Para este exercício, você criará uma imagem com base na `microsoft/aspnet` Imagem localizada no [Hub do Docker](https://hub.docker.com/r/microsoft/aspnet/).
